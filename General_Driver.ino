...
PIDController pidZ(0.0, 0.0, 0.0);
...
void loop() {
  ...
  if (isMoving && !heartbeatStopFlag) {
      setGoalSpeed(targetLinearVelocity, targetAngularVelocity);
  } else {
      setGoalSpeed(0, 0);
  }
  if (baseFeedbackFlow) {
  ...
  //Serial.print("GyroX: "); Serial.print(gx); Serial.print("GyroY: "); Serial.print(gy); Serial.print("GyroZ: "); Serial.println(gz);
